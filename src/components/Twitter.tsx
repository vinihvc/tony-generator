    ...
    >
      <div className="flex justify-between">
        <div className="flex items-center">
          <img className="w-11 h-11 rounded-full" src={tony} />
        ...
        <svg
          className="inline-block w-auto h-6 text-blue-400 dark:text-white fill-current"
          viewBox="0 0 24 24"
        >
          <g>
      ...
      <p className="block mt-3 text-xl leading-snug text-black dark:text-white">
        {tonyText(
          `“${
            text ||
      ...
      <p className="py-1 my-0.5 text-base text-gray-500 dark:text-gray-400">
      ...
      <div className="flex mt-3 text-gray-500 dark:text-gray-400">
        <div className="flex items-center mr-6 ">
          <svg className="w-auto h-5 fill-current" viewBox="0 0 24 24">
            <g>
